						...
						<tbody>
							<c:forEach items="${categories}" var="cat">
								<tr>
									...
									<td class="text-nowrap"><c:out value="${cat.metaTag}"></c:out></td>
									<td class="text-nowrap"><c:out value="${cat.url}"></c:out></td>
									<td class="text-nowrap"><c:out value="${cat.discription}"></c:out></td>
									<td><c:choose>
									...
									<td><span>  
											<a href="update-category?catId=${cat.catId}"><i
										...
										</a> <input type="hidden" value="${cat.catId }" id="deleteId">
										</span></td>
								</tr>
							</c:forEach>
	...
	<div class="modal fade " id="staticBackdrop" data-bs-backdrop="static"
		...
		<div class="modal-dialog">
			<div class="modal-content rounded-0">
				<form
					action="${pageContext.request.contextPath }/category/delete-category"
					method="post">
					...
					<input type="hidden" id="deleteId" name="catId">
